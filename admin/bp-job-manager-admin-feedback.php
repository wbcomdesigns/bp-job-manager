...
if ( ! class_exists( 'Bp_Job_Manager_Admin_Feedback' ) ) :

	/**
	 * The feedback.
	 */
	class Bp_Job_Manager_Admin_Feedback {
			...
			<div class="notice updated bp-job-manager-notice">
				<div class="bp-job-manager-notice-inner">
					...
					<div class="bp-job-manager-install-now">
						<?php printf( '<a href="%1$s" class="button button-primary bp-job-manager-install-button" target="_blank">%2$s</a>', esc_url( 'https://wordpress.org/support/plugin/bp-job-manager/reviews/' ), esc_html__( 'Leave a Review', 'bp-job-manager' ) ); ?>
...
/*
* Instantiate the Bp_Job_Manager_Admin_Feedback class.
*/
new Bp_Job_Manager_Admin_Feedback(
	array(
		'slug'       => 'bp_jo_manager',
